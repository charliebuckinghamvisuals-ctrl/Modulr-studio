...
export interface SceneObject {
  ...
  widthMm?: number;
  depthMm?: number;
  /** Height in mm, for the one object sized that way: the acoustic slat
   *  panel (utils/acousticPanel). Unset = its native 2000. */
  heightMm?: number;
  color?: string;
