...
export const INTERIOR_TYPES: ObjectType[] = [
  ...
  'desk', 'sofa', 'sofa_2seater', 'sofa_l', 'sofa_3', 'sofa_4', 'sofa_5', 'sofa_6', 'footstool', 'armchair', 'armchair_2', 'armchair_3', 'dining_table',
...
export const FOOTPRINT_RADIUS: Partial<Record<ObjectType, number>> = {
  bed: 1.3, sofa: 1.5, sofa_l: 1.8, sofa_3: 1.2, sofa_4: 1.6, sofa_5: 1.35, sofa_6: 1.0,
  outdoor_sofa: 1.3, outdoor_chair: 0.75, outdoor_table: 0.7, bbq: 0.8, armchair: 0.8, armchair_2: 0.7, armchair_3: 0.7, rug: 1.5, rug_2: 1.4, footstool: 0.6,
...
const EXTERIOR_TYPES = new Set<string>(['wall_light_sconce', 'wall_light_angled', 'wall_light_box', 'wall_light_slim', 'hot_tub', 'garden_steps', 'garden_ramp', 'aircon_outdoor', 'external_extraction_fan', 'canopy_spot', 'outdoor_sofa', 'outdoor_chair', 'outdoor_table', 'bbq']);
