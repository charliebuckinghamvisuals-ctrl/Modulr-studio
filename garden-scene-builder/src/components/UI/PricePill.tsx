...
export function PricePill() {
  ...
  return (
    <div className="absolute bottom-24 left-8 bg-white/80 backdrop-blur-2xl text-[#3b4d4a] border border-black/5 px-6 py-4 rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] z-10 flex flex-col pointer-events-none">
