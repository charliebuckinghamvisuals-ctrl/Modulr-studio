...
const TOOLS: ToolGuide[] = [
    {
        ...
        purpose:
            'Build the actual geometry of a garden room or annexe to real dimensions, walk around it and through it, then send any view straight into the Render Engine.',
        ...
        steps: [
            ...
            'Set the footprint: width, depth and wall height, in millimetres. The permitted development flag under the sliders updates as the height changes.',
            ...
            'Pick cladding, roof and frame finishes on the Finish step. Cladding can differ per elevation, and the frame can be aluminium, uPVC or timber.',
            'On Openings, add doors and windows. Choose the door set - hinged, French, bi-fold or sliding - and it opens the way the real product does. Drag anywhere on the wall or nudge with the keyboard; every handle snaps to clean steps.',
            'On Extras, add decking, a canopy, a picture-frame front, a garden boundary or a covered outdoor section open to the garden under the same roof.',
            'On Interior, add internal walls. Each one is a single object you select and drag, it snaps to the shell, and any door you put in it belongs to that wall and travels with it. Then set out the kitchen, bathroom, furniture and lights.',
        ...
        uses: [
            ...
            'Walk a client around the outside and through the inside of the building they are buying',
            ...
            'Lay out the kitchen, bathroom and bedroom of an annexe, so a client can see where everything falls',
        ...
        tips: [
            ...
            'The lens slider at the bottom right frames the shot that goes to the Render Engine. The walkthrough keeps its own lens.',
            'In the walkthrough, T switches between inside and outside, and Esc gives you the mouse back.',
    ...
    },
    {
        ...
        name: 'Render Engine',
        purpose:
            'Turn a drawing, model screenshot or photograph into a finished pro-level CGI exterior visual.',
        inputs: [
