...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: "bg-gradient-to-r from-slate-200 to-white text-black shadow-[0_0_20px_rgba(139,92,246,0.2)] hover:shadow-[0_0_30px_rgba(139,92,246,0.4)] hover:-translate-y-0.5 border border-accent/20",
