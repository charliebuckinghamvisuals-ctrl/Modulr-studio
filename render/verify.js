...
const PROMPT = (n) => [
    ...
    'For EACH item, judge image 2 against image 1: present - the item is there; unchanged - same shape, size, position and extent as the reference (a deck that is smaller, cut back or partly replaced by lawn is NOT unchanged; a door with a different leaf count or a solid door shown glazed is NOT unchanged; a light fitting of a different style or in a different place is NOT unchanged). Lighting, sky, planting beyond the boundary and surface texture are allowed to differ and never count against an item.',
