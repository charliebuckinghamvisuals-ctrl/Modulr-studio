...
export function buildRenderPrompt({ inventoryText, hasLine, scenePreset, timePreset, sceneText }) {
    ...
    return [
        ...
        `SETTING - the only thing you may dress, and only OUTSIDE the drawn items: ${setting || 'a simple lawn with a few shrubs beyond the boundary.'} Lawn, planting, sky, distant trees and neighbours live where the drawing shows plain ground or nothing at all; they never cover, replace or cut into a drawn item.`,
